...
<body>
    <div style="height: 100%; width: 100%;">
        ...
        <div style="width: 100%; height: 1000px; background-color:#f7f6f2 ; position: relative; margin-top: 30px;">
            <div style="display: flex; position: absolute; background-color:#f7f6f2; height: auto; width: 75%; left: 50%; transform: translateX(-50%); top: -13%; border-radius: 20px;">
                <div class="container">
                    <div class="row g-4">
                        <div class="col-lg-5 col-12 d-flex flex-column justify-content-between" style="padding: 40px 40px 0;">
                            <div>
                        ...
                        <div class="col-lg-7 col-12 d-flex flex-column" style=" background-color: white; border-radius: 20px; padding: 40px 40px 0">
                            <div class="title">
