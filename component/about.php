...
<body>
    <div style="height: 100%; width: 100%; ">
        ...
        <div class="about" style="z-index: 2; width: 100%; height: 930px; background-color: #f7f6f2; margin-top: 15px; padding-top: 20px;">
        ...
        <div style=" position: relative; background-color: transparent; background-size: cover; background-position: center; width: 100%; height: 600px; background-image: url('https://websitedemos.net/pizzeria-04/wp-content/uploads/sites/791/2021/03/pizzeria-template-near-fireplace-img.jpg');">
            <div style="height: 500px; width: 600px; background-color: white; position: absolute; left: 10%; top: 10%; padding: 40px 35px 0;">
        ...
        <div style=" position: relative; background-color: transparent; background-size: cover; background-position: center; width: 100%; height: 600px; background-image: url('https://websitedemos.net/pizzeria-04/wp-content/uploads/sites/791/2021/03/pizzeria-template-fresh-ingredients-img-1.jpg');">
            <div style="height: 500px; width: 600px; background-color: white; position: absolute; right: 10%; top: 10%; padding: 40px 35px 0;">
