...
<div class="changepassword d-flex flex-column justify-content-start shadow-lg" style=" background-color: white; border-radius: 20px; padding: 40px 40px 0; height:700px">
    ...
    <div class="border border-2 d-flex flex-column justify-content-between flex-wrap align-content-center pb-3 " style="flex: 3; height: 100%; width: 100px; margin-right: 20px; background-color: #f7f6f2; border-radius: 30px;">
            ...
            <div class="d-flex flex-column justify-content-between flex-wrap align-content-center  w-100">
        ...
        <div class="border border-2" style="flex: 6;margin-left: 50px; background-color: #f7f6f2 ; border-radius: 30px">
